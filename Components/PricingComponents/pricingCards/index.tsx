...
import UsePaymentMethod from "@component/Components/DashboardComp/PricingPlans/paymentMethods/usePaymentMethods";
...
interface Prop {
  ...
  setActive?: any;
  setPlandata?: any;
  // handleBillingpayment?: any;
  setBillingmethod?: any;
  currentPlanInfo?: any;
}

const PricingCards = (prop: Prop) => {
  const {
    handleActivePayment,
    plansDetails,
    planLoading,
  ...
  const { setSelectedplan, dispatch } = UsePaymentMethod();
  return (
    <>
                      ...
                      <div
                        ...
                        onClick={() => {
                          if (
                            ...
                            PlanTypeEnum.StarterPlan
                          ) {
                            toast.info(
                              "You cannot purchase a new plan without canceling your current plan first."
                            );
                            return;
                          }
                          setActive(1),
                            //  handleBillingpayment(item);
                            setPlandata(item);
                          setBillingmethod(1);
                  ...
                  <div className={styles.card} key={index}>
                    ...
                    <div className={styles.details}>
                      ...
                      <div className={styles.textWrapper}>
                        ...
                        {item?.starterPlanBenefits?.addCategory}
                      </div>
                      <div className={styles.textWrapper}>
                        <div className={styles.imgWrapper}>
                          <AiOutlineCheck />
